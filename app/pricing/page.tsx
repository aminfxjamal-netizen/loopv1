  ...
  return (
    <div className="min-h-screen bg-[#080808] text-white font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-gray-400 mb-4">14-day free trial on Pro and Business. No credit card required for trial.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-12">
          ...
          <div className="border border-white/10 rounded-2xl p-8 flex flex-col bg-[#0d0d0d]">
            ...
            <button onClick={handleFreeTrial} className="bg-white/10 text-white text-sm font-medium text-center py-3 rounded-xl hover:bg-white/20 transition-colors w-full">
              Start Free Trial
            </button>
          ...
          <div className="border-2 border-blue-500 rounded-2xl p-8 flex flex-col bg-[#0d0d0d] relative">
            ...
            <ul className="space-y-3 mb-8 flex-1">
              ...
              <li className="flex items-center gap-2 text-sm text-gray-300"><Check size={16} className="text-green-500 shrink-0" /> Everything in Free Trial</li>
            ...
            <button onClick={() => handlePaidPlan('pro')} className="bg-blue-500 text-white text-sm font-medium text-center py-3 rounded-xl hover:bg-blue-600 transition-colors w-full flex items-center justify-center gap-2">
              Choose Pro <ArrowRight size={14} />
            </button>
            <p className="text-xs text-gray-500 text-center mt-2">14-day free trial, then $15/mo</p>
          </div>
          ...
          <div className="border border-white/10 rounded-2xl p-8 flex flex-col bg-[#0d0d0d]">
            ...
            <button onClick={() => handlePaidPlan('business')} className="bg-white/10 text-white text-sm font-medium text-center py-3 rounded-xl hover:bg-white/20 transition-colors w-full flex items-center justify-center gap-2">
              Choose Business <ArrowRight size={14} />
            </button>
            <p className="text-xs text-gray-500 text-center mt-2">14-day free trial, then $30/mo</p>
          </div>
        </div>
      </div>
    </div>
